...
export function initDB() {
  return new Promise<Database>((resolve) => {
    ...
    db.serialize(() => {
      ...
      db.run('CREATE TABLE IF NOT EXISTS job_queue (id TEXT, slack_id TEXT, date TEXT, user_name TEXT, PRIMARY KEY(id, slack_id))');
      ...
      db.run(`CREATE TABLE IF NOT EXISTS filter (slack_id TEXT, user_name TEXT, filter_name TEXT, priority INT, subject TEXT, 'from' TEXT, 'to' TEXT, cc TEXT, action_type TEXT, forward_channel TEXT, memo TEXT, PRIMARY KEY(slack_id, user_name, filter_name))`);
      resolve(db);
    });
  });
}
